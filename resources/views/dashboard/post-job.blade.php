                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company" class="form-control rounded" placeholder="Title" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="salary" class="form-control rounded" placeholder="500$ - 1000$" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-dark">Application Deadline</label>
                                            <input type="date" name="dealine" class="form-control rounded" placeholder="dd-mm-yyyy" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="text-dark">Applicant Limit</label>
                                            <input type="text" name="applicant_limit" class="form-control rounded" placeholder="1000" />
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="mb-3" id="requirements-container">
                                                    <div class="d-flex requirement mb-3">
                                                        ...
                                                        <button class="btn btn-danger py-2 px-3 text-white rounded" onclick="removeRequirement(this)">Delete
                                                        </button>
                                                    </div>
                                                </div>
                                                <button type="button" class="btn fw-light shadow-none theme-bg text-white" id="add-requirement" onclick="addRequirement()">Add
                                                    Requirement
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="full_address" class="form-control" placeholder="#10 Marke Juger, SBI Road" />
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
